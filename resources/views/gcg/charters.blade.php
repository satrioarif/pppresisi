...
@section('title', 'Charters - GCG | PP Presisi')
...
<div class="bg-ppblue-900 pt-32 pb-24 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <h1 class="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-white mb-5 leading-tight">
            <span class="text-blue-300">Charters</span>
        </h1>
        <p class="text-blue-100 text-lg max-w-2xl mx-auto leading-relaxed">
            Our commitment to ethical standards and business integrity.
        </p>
    </div>
</div>
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-start gap-5 mb-10 mt-8">
            ...
            <div>
                <h2 class="text-2xl md:text-3xl font-heading font-bold text-gray-900">
                    <span class="font-extrabold" style="color: #111827;">Charters Documents</span>
                </h2>
                <p class="text-gray-500 text-sm mt-1">Download official corporate charters and related documents.</p>
            </div>
        </div>
        ...
        @else
            <div class="text-center py-14 rounded-2xl border-2 border-blue-200 border-dashed" style="background: #eff6ff;">
                ...
                <p class="text-gray-400 text-sm">Upload documents via the admin panel using type <strong>Charters</strong>.</p>
            </div>
        @endif
