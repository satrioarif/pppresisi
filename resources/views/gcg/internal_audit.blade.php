...
<x-page-header badge="Good Corporate Governance" subtitle="Information regarding our internal audit operations.">
    Internal Audit <span class="text-ppblue-300">Unit</span>
</x-page-header>
        ...
        <div class="flex items-start gap-5 mb-8 mt-8">
            ...
            <div>
                <h2 class="text-2xl md:text-3xl font-heading font-bold text-gray-900">
                    <span class="font-extrabold">Internal Audit</span>
                </h2>
            ...
            <div class="p-8 md:p-10 flex flex-col md:flex-row gap-8">
                ...
                <div class="w-full md:w-64 flex-shrink-0 flex flex-col items-center">
                    ...
                    <div class="text-center">
                        ...
                        <h6 class="text-sm font-medium text-ppblue-600 mt-1">Head of Internal Audit Unit</h6>
                    </div>
                </div>
            </div>
        </div>
