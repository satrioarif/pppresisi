...
<x-page-header badge="Good Corporate Governance" subtitle="Information regarding our corporate committees.">
    <span class="text-ppblue-300">Committees</span>
</x-page-header>
        ...
        <div class="flex items-start gap-5 mb-10 mt-8">
            ...
            <div>
                <h2 class="text-2xl md:text-3xl font-heading font-bold text-gray-900">
                    <span class="font-extrabold">Committees Documents</span>
                </h2>
