...
<div class="bg-ppblue-900 pt-32 pb-24 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <h1 class="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-white mb-5 leading-tight">
            Transparency of <span class="text-blue-300">Information</span>
        </h1>
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-start gap-5 mb-10">
            ...
            <div>
                <h2 class="text-2xl md:text-3xl font-heading font-bold text-gray-900">
                    <span class="font-extrabold" style="color: #111827;">Transparency of Information</span>
                </h2>
                <p class="text-gray-500 text-sm mt-1">Official public disclosures and material information.</p>
            </div>
        </div>
        ...
        @else
            <div class="text-center py-14 rounded-2xl border-2 border-blue-200 border-dashed" style="background: #eff6ff;">
                ...
                <p class="text-gray-400 text-sm">Upload documents via the admin panel using type <strong>Transparency of Information</strong>.</p>
            </div>
        @endif
